...
$st = db()->prepare('
  SELECT id, title, status, comment,
         filament_name, material, strength_needed, client_contact,
  ...
  <section>
    <div class="card">
      ...
      <div class="content-item" style="margin-top:1.2rem">
        ...
        <?php if (!empty($u['name'])): ?>
          <div><b>Имя:</b> <?=e((string)$u['name'])?></div>
        <?php endif; ?>
      ...
      <?php if (!$orders): ?>
        <div class="content-item">Пока нет заказов. Нажмите “Создать новый заказ”.</div>
      <?php else: ?>
        <table class="table">
          <thead>
            <tr>
            ...
            <?php foreach ($orders as $o): ?>
              <tr>
                ...
                <td>
                  ...
                  <?php if (!empty($o['client_contact'])): ?><div><b>Контакт:</b> <?=e((string)$o['client_contact'])?></div><?php endif; ?>
                  <?php if (!empty($o['comment'])): ?><div><b>Комментарий:</b> <?=e((string)$o['comment'])?></div><?php endif; ?>
                </td>
                <td><?=e((string)$o['updated_at'])?></td>
              </tr>
            <?php endforeach; ?>
          </tbody>
        </table>
